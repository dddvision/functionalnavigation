...
{
struct mexdata *dat=(struct mexdata *)adata;
typedef void (*projMS)(int j, double *aj, double *bi, double *xij, double **adata);
projMS proj;
  ...
  /* ...and call it */
  (*proj)(j, aj, bi, xij, dat->dynadata);
}

static void projac_motstrDL(int j, int i, double *aj, double *bi, double *Aij, double *Bij, void *adata)
{
struct mexdata *dat=(struct mexdata *)adata;
typedef void (*projacMS)(int j, double *aj, double *bi, double *Aij, double *Bij, double **adata);
projacMS projac;
  ...
  /* ...and call it */
  (*projac)(j, aj, bi, Aij, Bij, dat->dynadata);
}
