...
% Copyright 2006 David D. Diel, MIT License
  methods (Access = public, Static = true)
    function [y0, y1, y2] = axisToEuler(v0, v1, v2)
      ...
      [r00, r10, r20, r01, r11, r21, r02, r12, r22] = tom.Rotation.axisToMatrix(v0, v1, v2);
      [y0, y1, y2] = tom.Rotation.matrixToEuler(r00, r10, r20, r01, r11, r21, r02, r12, r22);
      if(nargout<=1)
    ...
    function [q0, q1, q2, q3] = axisToQuat(v0, v1, v2)
      ...
      qRaw2 = s.*vNorm1;
      qRaw3 = s.*vNorm2;
      [q0, q1, q2, q3] = tom.Rotation.quatNorm(qRaw0, qRaw1, qRaw2, qRaw3);
      if(nargout<=1)
    ...
    function [v0, v1, v2] = eulerToAxis(y0, y1, y2)
      ...
      [q0, q1, q2, q3] = tom.Rotation.eulerToQuat(y0, y1, y2);
      [v0, v1, v2] = tom.Rotation.quatToAxis(q0, q1, q2, q3);
      if(nargout<=1)
    ...
    function [v0, v1, v2] = matrixToAxis(r00, r10, r20, r01, r11, r21, r02, r12, r22)
      ...
      [q0, q1, q2, q3] = tom.Rotation.matrixToQuat(r00, r10, r20, r01, r11, r21, r02, r12, r22);
      [v0, v1, v2] = tom.Rotation.quatToAxis(q0, q1, q2, q3);
      if(nargout<=1)
        v0 = shiftdim(reshape(cat(1, v0(:), v1(:), v2(:)), numel(v0), 3), 1);
      end
    ...
    function [v0, v1, v2] = quatToAxis(q0, q1, q2, q3)
      ...
      [qNorm0, qNorm1, qNorm2, qNorm3] = tom.Rotation.quatNorm(q0, q1, q2, q3);
    ...
    function [y0, y1, y2] = quatToEuler(q0, q1, q2, q3)
      ...
      [q0, q1, q2, q3] = tom.Rotation.quatNorm(q0, q1, q2, q3);
      q00 = q0.*q0;
      q11 = q1.*q1;
      q22 = q2.*q2;
      q33 = q3.*q3;
