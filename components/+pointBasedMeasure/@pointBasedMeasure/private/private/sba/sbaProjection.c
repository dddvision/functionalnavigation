...
API_MOD void CALL_CONV affinetr3k4k5kap1kap2pp1pp2Ignored(int j, double *rtk, double *xyz, double *xij, void *adata) { 
...
API_MOD void CALL_CONV affinetr3k4k5kap1kap2pp1pp2IgnoredJac(int j, double *rtk, double *xyz, double *Aij, double *Bij, void *adata) { 
double x, y, z, q1, q2, q3, q4, tr1, tr2, k1, k2, k3;
...
API_MOD void CALL_CONV affinetr3k1k2k3k4k5kap1kap2pp1pp2Ignored(int j, double *rt, double *xyz, double *xij, void *adata) { 
double x, y, z, q1, q2, q3, q4, tr1, tr2;

double t4, t5, t6, t7, t8, t9;
fprintf(stderr,"coin3");
x = xyz[0];
y = xyz[1];
z = xyz[2];
q1 = rt[0];
...
API_MOD void CALL_CONV affinetr3k1k2k3k4k5kap1kap2pp1pp2IgnoredJac(int j, double *rt, double *xyz, double *Aij, double *Bij, void *adata) { 
double x, y, z, q1, q2, q3, q4, tr1, tr2;
...
API_MOD void CALL_CONV projectivekap1kap2pp1pp2Ignored(int j, double *rtk, double *xyz, double *xij, void *adata) { 
...
API_MOD void CALL_CONV projectivekap1kap2pp1pp2IgnoredJac(int j, double *rtk, double *xyz, double *Aij, double *Bij, void *adata) { 
double x, y, z, q1, q2, q3, q4, tr1, tr2, tr3, k1, k2, k3, k4, k5;
...
API_MOD void CALL_CONV projectivek1k2k3k4k5kap1kap2pp1pp2Ignored(int j, double *rt, double *xyz, double *xij, void *adata) { 
...
API_MOD void CALL_CONV projectivek1k2k3k4k5kap1kap2pp1pp2IgnoredJac(int j, double *rt, double *xyz, double *Aij, double *Bij, void *adata) { 
double x, y, z, q1, q2, q3, q4, tr1, tr2, tr3;
...
API_MOD void CALL_CONV affineFull(int j, double *p, double *xyz, double *xij, void *adata) { 
double x, y, z, p1, p2, p3, p4, p5, p6, p7, p8;
fprintf(stderr,"coinToto");
x = xyz[0];
y = xyz[1];
z = xyz[2];
p1 = p[0];
...
API_MOD void CALL_CONV affineFullJac(int j, double *p, double *xyz, double *Aij, double *Bij, void *adata) { 
double x, y, z, p1, p2, p3, p4, p5, p6, p7, p8;
...
API_MOD void CALL_CONV projectiveFull(int j, double *p, double *xyz, double *xij, void *adata) { 
...
API_MOD void CALL_CONV projectiveFullJac(int j, double *p, double *xyz, double *Aij, double *Bij, void *adata) { 
double x, y, z, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12;
...
API_MOD void CALL_CONV affineNRSFM(int j, double *rt, double *xyz, double *xij, double **adata) {
double x, y, z, q1, q2, q3, q4, tr1, tr2;
...
affinetr3k1k2k3k4k5kap1kap2pp1pp2Ignored( j, rt, xyzTot, xij, adata);
}

API_MOD void CALL_CONV affineNRSFMJac(int j, double *rt, double *xyz, double *Aij, double *Bij, double **adata) {
double x, y, z, q1, q2, q3, q4, tr1, tr2;
