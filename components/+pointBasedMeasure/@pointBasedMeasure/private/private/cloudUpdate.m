...
[ hCam nCam hGT animGT hConn camMode showTitle showGT ...
  alignGT showConn ] = getPrmDflt( varargin, dfs );
...
%     animGT = generateToyAnimation( 4.2, 'fixT', true );
%     anim = animGT;
%     anim.S(3,:,:) = -anim.S(3,:,:);
%     for i = 1 : size(anim.R,3)
%       anim.R(:,3,i) = -anim.R(:,3,i);
%       anim.R(3,:,i) = -anim.R(3,:,i);
%     end
%     playAnim(anim,'animGT',animGT,'showGT',true)
