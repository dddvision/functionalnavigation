namespace BrownianPlanar
{
  ...
  const double BrownianPlanar::initialPosition[3] = {6378137.0, 0, 0}; // initial position in ECEF
  const double BrownianPlanar::initialQuaternion[4] = {1, 0, 0, 0}; // unit magnitude to machine precision
